function[Traj] = getTraj(parameter_filename,eigvalues,eigvectors)
...
for i = 0:N_t-1
    total_response = getResponseFunction(ca,lowest_mode_number,highest_mode_number,solvent_friction,time_sequence(i+1),eigvalues,eigvectors);
